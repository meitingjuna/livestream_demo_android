...
public class LiveListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        footView = inflater.inflate(R.layout.em_listview_footer_view, listView, false);
        return view;
    }
...
//        footView = getLayoutInflater().inflate(R.layout.em_listview_footer_view, listView, false);
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
                    if (pageCount != 0) {
                        int lasPost = gm.findLastVisibleItemPosition();
                        if (hasMoreData && isLoading && lasPost == listView.getCount() - 1) {
                            loadAndShowData();
                        }
                    }
                }
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    //get chat room list
                   L.e(TAG,"chatRooms="+chatRoomList.size() );
